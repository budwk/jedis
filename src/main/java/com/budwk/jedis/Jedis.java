...
import static com.budwk.jedis.Protocol.SentinelKeyword.*;
...
import com.budwk.jedis.commands.*;
import com.budwk.jedis.exceptions.InvalidURIException;
...
import com.budwk.jedis.util.JedisURIHelper;
...
//    return connection.getStatusCodeReply();
 ...
 resulting sorted set, it is returned to the connection.
  ...
  /**
   * @deprecated Use {@link Jedis#shutdown(ShutdownParams)}.
   */
  @Override
  @Deprecated
...
//    connection.monitor();
  ...
  public String slaveof(final String host, final int port) {
    connection.sendCommand(SLAVEOF, SafeEncoder.encode(host), toByteArray(port));
    return connection.getStatusCodeReply();
  }
  ...
  public String replicaof(final String host, final int port) {
    connection.sendCommand(REPLICAOF, SafeEncoder.encode(host), toByteArray(port));
    return connection.getStatusCodeReply();
  }
  ...
  /**
   * @deprecated Use {@link Jedis#xpending(byte[], byte[], XPendingParams)}.
   */
  @Override
  @Deprecated
  ...
  public long move(final String key, final int dbIndex) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(MOVE, SafeEncoder.encode(key), toByteArray(dbIndex));
    return connection.getIntegerReply();
  }
...
//    return connection.getStatusCodeReply();
  ...
  public String clientSetInfo(ClientAttributeOption attr, String value) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(CLIENT, SETINFO.getRaw(), attr.getRaw(), SafeEncoder.encode(value));
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterSetSlotNode(final int slot, final String nodeId) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(CLUSTER, ClusterKeyword.SETSLOT.getRaw(), toByteArray(slot), ClusterKeyword.NODE.getRaw(), SafeEncoder.encode(nodeId));
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterSetSlotMigrating(final int slot, final String nodeId) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(CLUSTER, ClusterKeyword.SETSLOT.getRaw(), toByteArray(slot), ClusterKeyword.MIGRATING.getRaw(), SafeEncoder.encode(nodeId));
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterSetSlotImporting(final int slot, final String nodeId) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(CLUSTER, ClusterKeyword.SETSLOT.getRaw(), toByteArray(slot), ClusterKeyword.IMPORTING.getRaw(), SafeEncoder.encode(nodeId));
    return connection.getStatusCodeReply();
  }
  ...
  public Long memoryUsage(final String key, final int samples) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(MEMORY, USAGE.getRaw(), SafeEncoder.encode(key), SAMPLES.getRaw(), toByteArray(samples));
    return connection.getIntegerReply();
  }
  ...
  /**
   * @deprecated Use {@link Jedis#xpending(java.lang.String, java.lang.String, XPendingParams)}.
   */
  @Override
  @Deprecated
