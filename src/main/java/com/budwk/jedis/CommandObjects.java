...
import static com.budwk.jedis.Protocol.Command.*;
import static com.budwk.jedis.Protocol.Keyword.*;

import java.util.*;
import java.util.stream.Collectors;

import com.budwk.jedis.args.*;
import com.budwk.jedis.bloom.*;
import com.budwk.jedis.commands.ProtocolCommand;
import com.budwk.jedis.graph.GraphProtocol;
import com.budwk.jedis.json.*;
import com.budwk.jedis.params.*;
import com.budwk.jedis.resps.*;
import com.budwk.jedis.search.*;
import com.budwk.jedis.search.aggr.AggregationBuilder;
import com.budwk.jedis.search.aggr.AggregationResult;
import com.budwk.jedis.search.schemafields.SchemaField;
import com.budwk.jedis.timeseries.*;
import com.budwk.jedis.util.KeyValue;
import org.json.JSONArray;
import org.json.JSONObject;

import com.budwk.jedis.Protocol.Command;
import com.budwk.jedis.Protocol.Keyword;
import com.budwk.jedis.args.*;
import com.budwk.jedis.bloom.*;
import com.budwk.jedis.json.*;
import com.budwk.jedis.json.DefaultGsonObjectMapper;
import com.budwk.jedis.json.JsonObjectMapper;
import com.budwk.jedis.params.*;
import com.budwk.jedis.resps.*;
import com.budwk.jedis.search.*;
import com.budwk.jedis.timeseries.*;
...
public class CommandObjects {
   ...
   * @param consumerName
   * @return
   * @deprecated Use {@link CommandObjects#xpending(java.lang.String, java.lang.String, XPendingParams)}.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link CommandObjects#xpending(byte[], byte[], XPendingParams)}.
   */
  @Deprecated
  ...
  public final CommandObject<String> ftCreate(String indexName, IndexOptions indexOptions, Schema schema) {
    CommandArguments args = commandArguments(SearchProtocol.SearchCommand.CREATE).add(indexName)
        .addParams(indexOptions).add(SearchProtocol.SearchKeyword.SCHEMA);
  ...
  public final CommandObject<String> ftCreate(String indexName, FTCreateParams createParams,
    ...
    CommandArguments args = commandArguments(SearchProtocol.SearchCommand.CREATE).add(indexName)
        .addParams(createParams).add(SearchProtocol.SearchKeyword.SCHEMA);
    schemaFields.forEach(field -> args.addParams(field));
    return new CommandObject<>(args, BuilderFactory.STRING);
  }

  public final CommandObject<String> ftAlter(String indexName, Schema schema) {
    CommandArguments args = commandArguments(SearchProtocol.SearchCommand.ALTER).add(indexName)
        .add(SearchProtocol.SearchKeyword.SCHEMA).add(SearchProtocol.SearchKeyword.ADD);
    schema.fields.forEach(field -> args.addParams(field));
    return new CommandObject<>(args, BuilderFactory.STRING);
  }
  ...
  public final CommandObject<SearchResult> ftSearch(String indexName, String query) {
    return new CommandObject<>(checkAndRoundRobinSearchCommand(commandArguments(SearchProtocol.SearchCommand.SEARCH), indexName).add(query),
        new SearchResult.SearchResultBuilder(true, false, false, true));
  }

  public final CommandObject<SearchResult> ftSearch(String indexName, String query, FTSearchParams params) {
    return new CommandObject<>(checkAndRoundRobinSearchCommand(commandArguments(SearchProtocol.SearchCommand.SEARCH), indexName)
        .add(query).addParams(params), new SearchResult.SearchResultBuilder(!params.getNoContent(), params.getWithScores(), false, true));
  }

  public final CommandObject<SearchResult> ftSearch(String indexName, Query query) {
    return new CommandObject<>(checkAndRoundRobinSearchCommand(commandArguments(SearchProtocol.SearchCommand.SEARCH), indexName).addParams(query),
        new SearchResult.SearchResultBuilder(!query.getNoContent(), query.getWithScores(), query.getWithPayloads(), true));
  }

  public final CommandObject<SearchResult> ftSearch(byte[] indexName, Query query) {
    return new CommandObject<>(checkAndRoundRobinSearchCommand(commandArguments(SearchProtocol.SearchCommand.SEARCH), indexName).addParams(query),
        new SearchResult.SearchResultBuilder(!query.getNoContent(), query.getWithScores(), query.getWithPayloads(), false));
  }

  public final CommandObject<String> ftExplain(String indexName, Query query) {
    return new CommandObject<>(checkAndRoundRobinSearchCommand(commandArguments(SearchProtocol.SearchCommand.EXPLAIN), indexName)
        .addParams(query), BuilderFactory.STRING);
  }

  public final CommandObject<List<String>> ftExplainCLI(String indexName, Query query) {
    return new CommandObject<>(checkAndRoundRobinSearchCommand(commandArguments(SearchProtocol.SearchCommand.EXPLAINCLI), indexName)
  ...
  public final CommandObject<AggregationResult> ftAggregate(String indexName, AggregationBuilder aggr) {
    return new CommandObject<>(checkAndRoundRobinSearchCommand(commandArguments(SearchProtocol.SearchCommand.AGGREGATE), indexName)
  ...
  public final CommandObject<AggregationResult> ftCursorRead(String indexName, long cursorId, int count) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.CURSOR).add(SearchProtocol.SearchKeyword.READ)
        .add(indexName).add(cursorId).add(SearchProtocol.SearchKeyword.COUNT).add(count),
        SearchBuilderFactory.SEARCH_AGGREGATION_RESULT_WITH_CURSOR);
  }

  public final CommandObject<String> ftCursorDel(String indexName, long cursorId) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.CURSOR).add(SearchProtocol.SearchKeyword.DEL)
  ...
  public final CommandObject<Map.Entry<AggregationResult, Map<String, Object>>> ftProfileAggregate(
    ...
    return new CommandObject<>(checkAndRoundRobinSearchCommand(commandArguments(SearchProtocol.SearchCommand.PROFILE), indexName)
        .add(SearchProtocol.SearchKeyword.AGGREGATE).addParams(profileParams).add(SearchProtocol.SearchKeyword.QUERY)
  ...
  public final CommandObject<Map.Entry<SearchResult, Map<String, Object>>> ftProfileSearch(
    ...
    return new CommandObject<>(checkAndRoundRobinSearchCommand(commandArguments(SearchProtocol.SearchCommand.PROFILE), indexName)
        .add(SearchProtocol.SearchKeyword.SEARCH).addParams(profileParams).add(SearchProtocol.SearchKeyword.QUERY)
        .addParams(query), new SearchProfileResponseBuilder<>(new SearchResult.SearchResultBuilder(
  ...
  public final CommandObject<Map.Entry<SearchResult, Map<String, Object>>> ftProfileSearch(
    ...
    return new CommandObject<>(checkAndRoundRobinSearchCommand(commandArguments(SearchProtocol.SearchCommand.PROFILE), indexName)
        .add(SearchProtocol.SearchKeyword.SEARCH).addParams(profileParams).add(SearchProtocol.SearchKeyword.QUERY).add(query)
        .addParams(searchParams), new SearchProfileResponseBuilder<>(new SearchResult.SearchResultBuilder(
  ...
  public final CommandObject<String> ftDropIndex(String indexName) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.DROPINDEX).add(indexName), BuilderFactory.STRING);
  }

  public final CommandObject<String> ftDropIndexDD(String indexName) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.DROPINDEX).add(indexName).add(SearchProtocol.SearchKeyword.DD),
        BuilderFactory.STRING);
  }

  public final CommandObject<String> ftSynUpdate(String indexName, String synonymGroupId, String... terms) {
    return new CommandObject<>(checkAndRoundRobinSearchCommand(commandArguments(SearchProtocol.SearchCommand.SYNUPDATE), indexName)
  ...
  public final CommandObject<Map<String, List<String>>> ftSynDump(String indexName) {
    return new CommandObject<>(checkAndRoundRobinSearchCommand(commandArguments(SearchProtocol.SearchCommand.SYNDUMP), indexName),
        SearchBuilderFactory.SEARCH_SYNONYM_GROUPS);
  }

  public final CommandObject<Long> ftDictAdd(String dictionary, String... terms) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.DICTADD).add(dictionary).addObjects((Object[]) terms),
        BuilderFactory.LONG);
  }

  public final CommandObject<Long> ftDictDel(String dictionary, String... terms) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.DICTDEL).add(dictionary).addObjects((Object[]) terms),
        BuilderFactory.LONG);
  }

  public final CommandObject<Set<String>> ftDictDump(String dictionary) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.DICTDUMP).add(dictionary), BuilderFactory.STRING_SET);
  }
  ...
  public final CommandObject<Map<String, Map<String, Double>>> ftSpellCheck(String index, String query) {
    return new CommandObject<>(checkAndRoundRobinSearchCommand(commandArguments(SearchProtocol.SearchCommand.SPELLCHECK), index).add(query),
  ...
  public final CommandObject<Map<String, Object>> ftInfo(String indexName) {
    return new CommandObject<>(checkAndRoundRobinSearchCommand(commandArguments(SearchProtocol.SearchCommand.INFO), indexName),
        BuilderFactory.ENCODED_OBJECT_MAP);
  }

  public final CommandObject<Set<String>> ftTagVals(String indexName, String fieldName) {
    return new CommandObject<>(checkAndRoundRobinSearchCommand(commandArguments(SearchProtocol.SearchCommand.TAGVALS), indexName)
        .add(fieldName), BuilderFactory.STRING_SET);
  }

  public final CommandObject<String> ftAliasAdd(String aliasName, String indexName) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.ALIASADD).add(aliasName).add(indexName), BuilderFactory.STRING);
  }

  public final CommandObject<String> ftAliasUpdate(String aliasName, String indexName) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.ALIASUPDATE).add(aliasName).add(indexName), BuilderFactory.STRING);
  }

   public final CommandObject<String> ftAliasDel(String aliasName) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.ALIASDEL).add(aliasName), BuilderFactory.STRING);
  }

  public final CommandObject<Map<String, String>> ftConfigGet(String option) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.CONFIG).add(SearchProtocol.SearchKeyword.GET).add(option), BuilderFactory.STRING_MAP_FROM_PAIRS);
  }
  ...
  public final CommandObject<String> ftConfigSet(String option, String value) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.CONFIG).add(SearchProtocol.SearchKeyword.SET).add(option).add(value), BuilderFactory.STRING);
  }
  ...
  public final CommandObject<Long> ftSugAdd(String key, String string, double score) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.SUGADD).key(key).add(string).add(score), BuilderFactory.LONG);
  }

  public final CommandObject<Long> ftSugAddIncr(String key, String string, double score) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.SUGADD).key(key).add(string).add(score).add(SearchProtocol.SearchKeyword.INCR), BuilderFactory.LONG);
  }

  public final CommandObject<List<String>> ftSugGet(String key, String prefix) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.SUGGET).key(key).add(prefix), BuilderFactory.STRING_LIST);
  }

  public final CommandObject<List<String>> ftSugGet(String key, String prefix, boolean fuzzy, int max) {
    CommandArguments args = commandArguments(SearchProtocol.SearchCommand.SUGGET).key(key).add(prefix);
    if (fuzzy) args.add(SearchProtocol.SearchKeyword.FUZZY);
  ...
  public final CommandObject<List<Tuple>> ftSugGetWithScores(String key, String prefix) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.SUGGET).key(key).add(prefix).add(SearchProtocol.SearchKeyword.WITHSCORES), BuilderFactory.TUPLE_LIST);
  }
  ...
  public final CommandObject<Boolean> ftSugDel(String key, String string) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.SUGDEL).key(key).add(string), BuilderFactory.BOOLEAN);
  }

  public final CommandObject<Long> ftSugLen(String key) {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand.SUGLEN).key(key), BuilderFactory.LONG);
  }

  public final CommandObject<List<String>> ftList() {
    return new CommandObject<>(commandArguments(SearchProtocol.SearchCommand._LIST), BuilderFactory.STRING_LIST);
  }
  // RediSearch commands

  // RedisJSON commands
  public final CommandObject<String> jsonSet(String key, Path2 path, Object object) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.SET).key(key).add(path).add(object), BuilderFactory.STRING);
  }

  public final CommandObject<String> jsonSetWithEscape(String key, Path2 path, Object object) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.SET).key(key).add(path).add(
  ...
  public final CommandObject<String> jsonSetWithPlainString(String key, Path path, String string) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.SET).key(key).add(path).add(string), BuilderFactory.STRING);
  }

  public final CommandObject<String> jsonSet(String key, Path2 path, Object object, JsonSetParams params) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.SET).key(key).add(path).add(object).addParams(params), BuilderFactory.STRING);
  }
  ...
  public final CommandObject<Object> jsonGet(String key) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.GET).key(key), new JsonObjectBuilder<>(Object.class));
  }

  public final <T> CommandObject<T> jsonGet(String key, Class<T> clazz) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.GET).key(key), new JsonObjectBuilder<>(clazz));
  }

  public final CommandObject<Object> jsonGet(String key, Path2... paths) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.GET).key(key).addObjects((Object[]) paths), JsonBuilderFactory.JSON_OBJECT);
  }

  public final CommandObject<Object> jsonGet(String key, Path... paths) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.GET).key(key).addObjects((Object[]) paths), new JsonObjectBuilder<>(Object.class));
  }

  public final CommandObject<String> jsonGetAsPlainString(String key, Path path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.GET).key(key).add(path), BuilderFactory.STRING);
  }

  public final <T> CommandObject<T> jsonGet(String key, Class<T> clazz, Path... paths) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.GET).key(key).addObjects((Object[]) paths), new JsonObjectBuilder<>(clazz));
  }

  public final CommandObject<List<JSONArray>> jsonMGet(Path2 path, String... keys) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.MGET).keys((Object[]) keys).add(path), JsonBuilderFactory.JSON_ARRAY_LIST);
  }

  public final <T> CommandObject<List<T>> jsonMGet(Path path, Class<T> clazz, String... keys) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.MGET).keys((Object[]) keys).add(path), new JsonObjectListBuilder<>(clazz));
  }

  public final CommandObject<Long> jsonDel(String key) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.DEL).key(key), BuilderFactory.LONG);
  }

  public final CommandObject<Long> jsonDel(String key, Path2 path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.DEL).key(key).add(path), BuilderFactory.LONG);
  }
  ...
  public final CommandObject<Long> jsonClear(String key) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.CLEAR).key(key), BuilderFactory.LONG);
  }

  public final CommandObject<Long> jsonClear(String key, Path2 path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.CLEAR).key(key).add(path), BuilderFactory.LONG);
  }
  ...
  public final CommandObject<List<Boolean>> jsonToggle(String key, Path2 path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.TOGGLE).key(key).add(path), BuilderFactory.BOOLEAN_LIST);
  }

  public final CommandObject<String> jsonToggle(String key, Path path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.TOGGLE).key(key).add(path), BuilderFactory.STRING);
  }

  public final CommandObject<Class<?>> jsonType(String key) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.TYPE).key(key), JsonBuilderFactory.JSON_TYPE);
  }

  public final CommandObject<List<Class<?>>> jsonType(String key, Path2 path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.TYPE).key(key).add(path), JsonBuilderFactory.JSON_TYPE_LIST);
  }

  public final CommandObject<Class<?>> jsonType(String key, Path path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.TYPE).key(key).add(path), JsonBuilderFactory.JSON_TYPE);
  }

  public final CommandObject<Long> jsonStrAppend(String key, Object string) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.STRAPPEND).key(key).add(
  ...
  public final CommandObject<List<Long>> jsonStrAppend(String key, Path2 path, Object string) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.STRAPPEND).key(key).add(path).add(
  ...
  public final CommandObject<Long> jsonStrLen(String key) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.STRLEN).key(key), BuilderFactory.LONG);
  }

  public final CommandObject<List<Long>> jsonStrLen(String key, Path2 path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.STRLEN).key(key).add(path), BuilderFactory.LONG_LIST);
  }

  public final CommandObject<Long> jsonStrLen(String key, Path path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.STRLEN).key(key).add(path), BuilderFactory.LONG);
  }

  public final CommandObject<JSONArray> jsonNumIncrBy(String key, Path2 path, double value) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.NUMINCRBY).key(key).add(path).add(value), JsonBuilderFactory.JSON_ARRAY);
  }

  public final CommandObject<Double> jsonNumIncrBy(String key, Path path, double value) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.NUMINCRBY).key(key).add(path).add(value), BuilderFactory.DOUBLE);
  }

  public final CommandObject<Long> jsonArrAppend(String key, String path, JSONObject... objects) {
    CommandArguments args = commandArguments(JsonProtocol.JsonCommand.ARRAPPEND).key(key).add(path);
  ...
  public final CommandObject<List<Long>> jsonArrAppend(String key, Path2 path, Object... objects) {
    CommandArguments args = commandArguments(JsonProtocol.JsonCommand.ARRAPPEND).key(key).add(path).addObjects(objects);
  ...
  public final CommandObject<List<Long>> jsonArrIndex(String key, Path2 path, Object scalar) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.ARRINDEX).key(key).add(path).add(scalar), BuilderFactory.LONG_LIST);
  }

  public final CommandObject<List<Long>> jsonArrIndexWithEscape(String key, Path2 path, Object scalar) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.ARRINDEX).key(key).add(path).add(
  ...
  public final CommandObject<List<Long>> jsonArrInsert(String key, Path2 path, int index, Object... objects) {
    CommandArguments args = commandArguments(JsonProtocol.JsonCommand.ARRINSERT).key(key).add(path).add(index).addObjects(objects);
    return new CommandObject<>(args, BuilderFactory.LONG_LIST);
  }

  public final CommandObject<List<Long>> jsonArrInsertWithEscape(String key, Path2 path, int index, Object... objects) {
    CommandArguments args = commandArguments(JsonProtocol.JsonCommand.ARRINSERT).key(key).add(path).add(index);
    for (Object object : objects) {
      args.add(getJsonObjectMapper().toJson(object));
    }
    return new CommandObject<>(args, BuilderFactory.LONG_LIST);
  ...
  public final CommandObject<Object> jsonArrPop(String key) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.ARRPOP).key(key), new JsonObjectBuilder<>(Object.class));
  }

  public final <T> CommandObject<T> jsonArrPop(String key, Class<T> clazz) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.ARRPOP).key(key), new JsonObjectBuilder<>(clazz));
  }

  public final CommandObject<List<Object>> jsonArrPop(String key, Path2 path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.ARRPOP).key(key).add(path), new JsonObjectListBuilder<>(Object.class));
  }

  public final CommandObject<Object> jsonArrPop(String key, Path path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.ARRPOP).key(key).add(path), new JsonObjectBuilder<>(Object.class));
  }

  public final <T> CommandObject<T> jsonArrPop(String key, Class<T> clazz, Path path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.ARRPOP).key(key).add(path), new JsonObjectBuilder<>(clazz));
  }

  public final CommandObject<List<Object>> jsonArrPop(String key, Path2 path, int index) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.ARRPOP).key(key).add(path).add(index), new JsonObjectListBuilder<>(Object.class));
  }

  public final CommandObject<Object> jsonArrPop(String key, Path path, int index) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.ARRPOP).key(key).add(path).add(index), new JsonObjectBuilder<>(Object.class));
  }

  public final <T> CommandObject<T> jsonArrPop(String key, Class<T> clazz, Path path, int index) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.ARRPOP).key(key).add(path).add(index), new JsonObjectBuilder<>(clazz));
  }

  public final CommandObject<Long> jsonArrLen(String key) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.ARRLEN).key(key), BuilderFactory.LONG);
  }

  public final CommandObject<List<Long>> jsonArrLen(String key, Path2 path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.ARRLEN).key(key).add(path), BuilderFactory.LONG_LIST);
  }

  public final CommandObject<Long> jsonArrLen(String key, Path path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.ARRLEN).key(key).add(path), BuilderFactory.LONG);
  }

  public final CommandObject<List<Long>> jsonArrTrim(String key, Path2 path, int start, int stop) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.ARRTRIM).key(key).add(path).add(start).add(stop), BuilderFactory.LONG_LIST);
  }

  public final CommandObject<Long> jsonArrTrim(String key, Path path, int start, int stop) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.ARRTRIM).key(key).add(path).add(start).add(stop), BuilderFactory.LONG);
  }

  public final CommandObject<Long> jsonObjLen(String key) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.OBJLEN).key(key), BuilderFactory.LONG);
  }

  public final CommandObject<Long> jsonObjLen(String key, Path path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.OBJLEN).key(key).add(path), BuilderFactory.LONG);
  }

  public final CommandObject<List<Long>> jsonObjLen(String key, Path2 path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.OBJLEN).key(key).add(path), BuilderFactory.LONG_LIST);
  }

  public final CommandObject<List<String>> jsonObjKeys(String key) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.OBJKEYS).key(key), BuilderFactory.STRING_LIST);
  }

  public final CommandObject<List<String>> jsonObjKeys(String key, Path path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.OBJKEYS).key(key).add(path), BuilderFactory.STRING_LIST);
  }

  public final CommandObject<List<List<String>>> jsonObjKeys(String key, Path2 path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.OBJKEYS).key(key).add(path), BuilderFactory.STRING_LIST_LIST);
  }

  public final CommandObject<Long> jsonDebugMemory(String key) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.DEBUG).add("MEMORY").key(key), BuilderFactory.LONG);
  }

  public final CommandObject<Long> jsonDebugMemory(String key, Path path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.DEBUG).add("MEMORY").key(key).add(path), BuilderFactory.LONG);
  }

  public final CommandObject<List<Long>> jsonDebugMemory(String key, Path2 path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.DEBUG).add("MEMORY").key(key).add(path), BuilderFactory.LONG_LIST);
  }

  public final CommandObject<List<Object>> jsonResp(String key) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.RESP).key(key), BuilderFactory.ENCODED_OBJECT_LIST);
  }

  public final CommandObject<List<Object>> jsonResp(String key, Path path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.RESP).key(key).add(path), BuilderFactory.ENCODED_OBJECT_LIST);
  }

  public final CommandObject<List<List<Object>>> jsonResp(String key, Path2 path) {
    return new CommandObject<>(commandArguments(JsonProtocol.JsonCommand.RESP).key(key).add(path), BuilderFactory.ENCODED_OBJECT_LIST_LIST);
  }
  // RedisJSON commands

  // RedisTimeSeries commands
  public final CommandObject<String> tsCreate(String key) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.CREATE).key(key), BuilderFactory.STRING);
  }

  public final CommandObject<String> tsCreate(String key, TSCreateParams createParams) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.CREATE).key(key).addParams(createParams), BuilderFactory.STRING);
  }

  public final CommandObject<Long> tsDel(String key, long fromTimestamp, long toTimestamp) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.DEL).key(key)
  ...
  public final CommandObject<String> tsAlter(String key, TSAlterParams alterParams) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.ALTER).key(key).addParams(alterParams), BuilderFactory.STRING);
  }

  public final CommandObject<Long> tsAdd(String key, double value) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.ADD).key(key).add(Protocol.BYTES_ASTERISK).add(value), BuilderFactory.LONG);
  }

  public final CommandObject<Long> tsAdd(String key, long timestamp, double value) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.ADD).key(key).add(timestamp).add(value), BuilderFactory.LONG);
  }

  public final CommandObject<Long> tsAdd(String key, long timestamp, double value, TSCreateParams createParams) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.ADD).key(key)
  ...
  public final CommandObject<List<Long>> tsMAdd(Map.Entry<String, TSElement>... entries) {
    CommandArguments args = commandArguments(TimeSeriesProtocol.TimeSeriesCommand.MADD);
  ...
  public final CommandObject<Long> tsIncrBy(String key, double value) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.INCRBY).key(key).add(value), BuilderFactory.LONG);
  }

  public final CommandObject<Long> tsIncrBy(String key, double value, long timestamp) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.INCRBY).key(key).add(value)
        .add(TimeSeriesProtocol.TimeSeriesKeyword.TIMESTAMP).add(timestamp), BuilderFactory.LONG);
  }

  public final CommandObject<Long> tsDecrBy(String key, double value) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.DECRBY).key(key).add(value), BuilderFactory.LONG);
  }

  public final CommandObject<Long> tsDecrBy(String key, double value, long timestamp) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.DECRBY).key(key).add(value)
        .add(TimeSeriesProtocol.TimeSeriesKeyword.TIMESTAMP).add(timestamp), BuilderFactory.LONG);
  }

  public final CommandObject<List<TSElement>> tsRange(String key, long fromTimestamp, long toTimestamp) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.RANGE).key(key)
  ...
  public final CommandObject<List<TSElement>> tsRevRange(String key, long fromTimestamp, long toTimestamp) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.REVRANGE).key(key)
        .add(fromTimestamp).add(toTimestamp), TimeSeriesBuilderFactory.TIMESERIES_ELEMENT_LIST);
  }
  ...
  public final CommandObject<List<TSKeyedElements>> tsMRange(long fromTimestamp, long toTimestamp, String... filters) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.MRANGE).add(fromTimestamp)
        .add(toTimestamp).add(TimeSeriesProtocol.TimeSeriesKeyword.FILTER).addObjects((Object[]) filters),
  ...
  public final CommandObject<List<TSKeyedElements>> tsMRange(TSMRangeParams multiRangeParams) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.MRANGE)
  ...
  public final CommandObject<List<TSKeyedElements>> tsMRevRange(long fromTimestamp, long toTimestamp, String... filters) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.MREVRANGE).add(fromTimestamp)
        .add(toTimestamp).add(TimeSeriesProtocol.TimeSeriesKeyword.FILTER).addObjects((Object[]) filters),
        TimeSeriesBuilderFactory.TIMESERIES_MRANGE_RESPONSE);
  }

  public final CommandObject<List<TSKeyedElements>> tsMRevRange(TSMRangeParams multiRangeParams) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.MREVRANGE).addParams(multiRangeParams),
        TimeSeriesBuilderFactory.TIMESERIES_MRANGE_RESPONSE);
  }

  public final CommandObject<TSElement> tsGet(String key) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.GET).key(key), TimeSeriesBuilderFactory.TIMESERIES_ELEMENT);
  }

  public final CommandObject<TSElement> tsGet(String key, TSGetParams getParams) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.GET).key(key).addParams(getParams), TimeSeriesBuilderFactory.TIMESERIES_ELEMENT);
  }

  public final CommandObject<List<TSKeyValue<TSElement>>> tsMGet(TSMGetParams multiGetParams, String... filters) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.MGET).addParams(multiGetParams)
        .add(TimeSeriesProtocol.TimeSeriesKeyword.FILTER).addObjects((Object[]) filters), TimeSeriesBuilderFactory.TIMESERIES_MGET_RESPONSE);
  }

  public final CommandObject<String> tsCreateRule(String sourceKey, String destKey, AggregationType aggregationType,
      long timeBucket) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.CREATERULE).key(sourceKey).key(destKey)
        .add(TimeSeriesProtocol.TimeSeriesKeyword.AGGREGATION).add(aggregationType).add(timeBucket), BuilderFactory.STRING);
  }

  public final CommandObject<String> tsCreateRule(String sourceKey, String destKey, AggregationType aggregationType,
      long bucketDuration, long alignTimestamp) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.CREATERULE).key(sourceKey).key(destKey)
        .add(TimeSeriesProtocol.TimeSeriesKeyword.AGGREGATION).add(aggregationType).add(bucketDuration).add(alignTimestamp), BuilderFactory.STRING);
  }

  public final CommandObject<String> tsDeleteRule(String sourceKey, String destKey) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.DELETERULE).key(sourceKey).key(destKey), BuilderFactory.STRING);
  }

  public final CommandObject<List<String>> tsQueryIndex(String... filters) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.QUERYINDEX)
        .addObjects((Object[]) filters), BuilderFactory.STRING_LIST);
  }

  public final CommandObject<TSInfo> tsInfo(String key) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.INFO).key(key), TSInfo.TIMESERIES_INFO);
  }

  public final CommandObject<TSInfo> tsInfoDebug(String key) {
    return new CommandObject<>(commandArguments(TimeSeriesProtocol.TimeSeriesCommand.INFO).key(key).add(TimeSeriesProtocol.TimeSeriesKeyword.DEBUG), TSInfo.TIMESERIES_INFO);
  }
  // RedisTimeSeries commands

  // RedisBloom commands
  public final CommandObject<String> bfReserve(String key, double errorRate, long capacity) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.BloomFilterCommand.RESERVE).key(key)
  ...
  public final CommandObject<Boolean> bfAdd(String key, String item) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.BloomFilterCommand.ADD).key(key).add(item), BuilderFactory.BOOLEAN);
  }

  public final CommandObject<List<Boolean>> bfMAdd(String key, String... items) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.BloomFilterCommand.MADD).key(key).
  ...
  public final CommandObject<List<Boolean>> bfInsert(String key, String... items) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.BloomFilterCommand.INSERT).key(key)
        .add(RedisBloomProtocol.RedisBloomKeyword.ITEMS).addObjects((Object[]) items), BuilderFactory.BOOLEAN_WITH_ERROR_LIST);
  }

  public final CommandObject<List<Boolean>> bfInsert(String key, BFInsertParams insertParams, String... items) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.BloomFilterCommand.INSERT).key(key).addParams(insertParams)
        .add(RedisBloomProtocol.RedisBloomKeyword.ITEMS).addObjects((Object[]) items), BuilderFactory.BOOLEAN_WITH_ERROR_LIST);
  }

  public final CommandObject<Boolean> bfExists(String key, String item) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.BloomFilterCommand.EXISTS).key(key).add(item), BuilderFactory.BOOLEAN);
  }

  public final CommandObject<List<Boolean>> bfMExists(String key, String... items) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.BloomFilterCommand.MEXISTS).key(key).
        addObjects((Object[]) items), BuilderFactory.BOOLEAN_LIST);
  }

  public final CommandObject<Map.Entry<Long, byte[]>> bfScanDump(String key, long iterator) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.BloomFilterCommand.SCANDUMP).key(key).add(iterator), BLOOM_SCANDUMP_RESPONSE);
  }

  public final CommandObject<String> bfLoadChunk(String key, long iterator, byte[] data) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.BloomFilterCommand.LOADCHUNK).key(key).add(iterator).add(data), BuilderFactory.STRING);
  }

  public final CommandObject<Long> bfCard(String key) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.BloomFilterCommand.CARD).key(key), BuilderFactory.LONG);
  }

  public final CommandObject<Map<String, Object>> bfInfo(String key) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.BloomFilterCommand.INFO).key(key), BuilderFactory.ENCODED_OBJECT_MAP);
  }

  public final CommandObject<String> cfReserve(String key, long capacity) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CuckooFilterCommand.RESERVE).key(key).add(capacity), BuilderFactory.STRING);
  }

  public final CommandObject<String> cfReserve(String key, long capacity, CFReserveParams reserveParams) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CuckooFilterCommand.RESERVE).key(key).add(capacity).addParams(reserveParams), BuilderFactory.STRING);
  }

  public final CommandObject<Boolean> cfAdd(String key, String item) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CuckooFilterCommand.ADD).key(key).add(item), BuilderFactory.BOOLEAN);
  }

  public final CommandObject<Boolean> cfAddNx(String key, String item) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CuckooFilterCommand.ADDNX).key(key).add(item), BuilderFactory.BOOLEAN);
  }

  public final CommandObject<List<Boolean>> cfInsert(String key, String... items) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CuckooFilterCommand.INSERT).key(key)
        .add(RedisBloomProtocol.RedisBloomKeyword.ITEMS).addObjects((Object[]) items), BuilderFactory.BOOLEAN_LIST);
  }

  public final CommandObject<List<Boolean>> cfInsert(String key, CFInsertParams insertParams, String... items) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CuckooFilterCommand.INSERT).key(key)
        .addParams(insertParams).add(RedisBloomProtocol.RedisBloomKeyword.ITEMS).addObjects((Object[]) items), BuilderFactory.BOOLEAN_LIST);
  }

  public final CommandObject<List<Boolean>> cfInsertNx(String key, String... items) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CuckooFilterCommand.INSERTNX).key(key)
        .add(RedisBloomProtocol.RedisBloomKeyword.ITEMS).addObjects((Object[]) items), BuilderFactory.BOOLEAN_LIST);
  }
  ...
  public final CommandObject<Boolean> cfExists(String key, String item) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CuckooFilterCommand.EXISTS).key(key).add(item), BuilderFactory.BOOLEAN);
  }

  public final CommandObject<List<Boolean>> cfMExists(String key, String... items) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CuckooFilterCommand.MEXISTS).key(key)
        .addObjects((Object[]) items), BuilderFactory.BOOLEAN_LIST);
  }

  public final CommandObject<Boolean> cfDel(String key, String item) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CuckooFilterCommand.DEL).key(key).add(item), BuilderFactory.BOOLEAN);
  }

  public final CommandObject<Long> cfCount(String key, String item) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CuckooFilterCommand.COUNT).key(key).add(item), BuilderFactory.LONG);
  }

  public final CommandObject<Map.Entry<Long, byte[]>> cfScanDump(String key, long iterator) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CuckooFilterCommand.SCANDUMP).key(key).add(iterator), BLOOM_SCANDUMP_RESPONSE);
  }

  public final CommandObject<String> cfLoadChunk(String key, long iterator, byte[] data) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CuckooFilterCommand.LOADCHUNK).key(key).add(iterator).add(data), BuilderFactory.STRING);
  }

  public final CommandObject<Map<String, Object>> cfInfo(String key) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CuckooFilterCommand.INFO).key(key), BuilderFactory.ENCODED_OBJECT_MAP);
  }

  public final CommandObject<String> cmsInitByDim(String key, long width, long depth) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CountMinSketchCommand.INITBYDIM).key(key).add(width).add(depth), BuilderFactory.STRING);
  }

  public final CommandObject<String> cmsInitByProb(String key, double error, double probability) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CountMinSketchCommand.INITBYPROB).key(key).add(error).add(probability), BuilderFactory.STRING);
  }

  public final CommandObject<List<Long>> cmsIncrBy(String key, Map<String, Long> itemIncrements) {
    CommandArguments args = commandArguments(RedisBloomProtocol.CountMinSketchCommand.INCRBY).key(key);
  ...
  public final CommandObject<List<Long>> cmsQuery(String key, String... items) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CountMinSketchCommand.QUERY).key(key).addObjects((Object[]) items), BuilderFactory.LONG_LIST);
  }

  public final CommandObject<String> cmsMerge(String destKey, String... keys) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CountMinSketchCommand.MERGE).key(destKey)
  ...
  public final CommandObject<String> cmsMerge(String destKey, Map<String, Long> keysAndWeights) {
    CommandArguments args = commandArguments(RedisBloomProtocol.CountMinSketchCommand.MERGE).key(destKey);
  ...
  public final CommandObject<Map<String, Object>> cmsInfo(String key) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.CountMinSketchCommand.INFO).key(key), BuilderFactory.ENCODED_OBJECT_MAP);
  }

  public final CommandObject<String> topkReserve(String key, long topk) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.TopKCommand.RESERVE).key(key).add(topk), BuilderFactory.STRING);
  }

  public final CommandObject<String> topkReserve(String key, long topk, long width, long depth, double decay) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.TopKCommand.RESERVE).key(key).add(topk)
  ...
  public final CommandObject<List<String>> topkAdd(String key, String... items) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.TopKCommand.ADD).key(key).addObjects((Object[]) items), BuilderFactory.STRING_LIST);
  }

  public final CommandObject<List<String>> topkIncrBy(String key, Map<String, Long> itemIncrements) {
    CommandArguments args = commandArguments(RedisBloomProtocol.TopKCommand.INCRBY).key(key);
    itemIncrements.entrySet().forEach(entry -> args.add(entry.getKey()).add(entry.getValue()));
    return new CommandObject<>(args, BuilderFactory.STRING_LIST);
  }

  public final CommandObject<List<Boolean>> topkQuery(String key, String... items) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.TopKCommand.QUERY).key(key).addObjects((Object[]) items), BuilderFactory.BOOLEAN_LIST);
  }

  public final CommandObject<List<Long>> topkCount(String key, String... items) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.TopKCommand.COUNT).key(key).addObjects((Object[]) items), BuilderFactory.LONG_LIST);
  }

  public final CommandObject<List<String>> topkList(String key) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.TopKCommand.LIST).key(key), BuilderFactory.STRING_LIST);
  }

  public final CommandObject<Map<String, Object>> topkInfo(String key) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.TopKCommand.INFO).key(key), BuilderFactory.ENCODED_OBJECT_MAP);
  }

  public final CommandObject<String> tdigestCreate(String key) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.TDigestCommand.CREATE).key(key), BuilderFactory.STRING);
  }

  public final CommandObject<String> tdigestCreate(String key, int compression) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.TDigestCommand.CREATE).key(key).add(RedisBloomProtocol.RedisBloomKeyword.COMPRESSION)
        .add(compression), BuilderFactory.STRING);
  }

  public final CommandObject<String> tdigestReset(String key) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.TDigestCommand.RESET).key(key), BuilderFactory.STRING);
  }

  public final CommandObject<String> tdigestMerge(String destinationKey, String... sourceKeys) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.TDigestCommand.MERGE).key(destinationKey)
  ...
  public final CommandObject<Map<String, Object>> tdigestInfo(String key) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.TDigestCommand.INFO).key(key), BuilderFactory.ENCODED_OBJECT_MAP);
  }

  public final CommandObject<String> tdigestAdd(String key, double... values) {
    return new CommandObject<>(addFlatArgs(commandArguments(RedisBloomProtocol.TDigestCommand.ADD).key(key), values),
        BuilderFactory.STRING);
  }

  public final CommandObject<List<Double>> tdigestCDF(String key, double... values) {
    return new CommandObject<>(addFlatArgs(commandArguments(RedisBloomProtocol.TDigestCommand.CDF).key(key), values),
        BuilderFactory.DOUBLE_LIST);
  }

  public final CommandObject<List<Double>> tdigestQuantile(String key, double... quantiles) {
    return new CommandObject<>(addFlatArgs(commandArguments(RedisBloomProtocol.TDigestCommand.QUANTILE).key(key),
        quantiles), BuilderFactory.DOUBLE_LIST);
  }

  public final CommandObject<Double> tdigestMin(String key) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.TDigestCommand.MIN).key(key), BuilderFactory.DOUBLE);
  }

  public final CommandObject<Double> tdigestMax(String key) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.TDigestCommand.MAX).key(key), BuilderFactory.DOUBLE);
  }

  public final CommandObject<Double> tdigestTrimmedMean(String key, double lowCutQuantile, double highCutQuantile) {
    return new CommandObject<>(commandArguments(RedisBloomProtocol.TDigestCommand.TRIMMED_MEAN).key(key).add(lowCutQuantile)
        .add(highCutQuantile), BuilderFactory.DOUBLE);
  }

  public final CommandObject<List<Long>> tdigestRank(String key, double... values) {
    return new CommandObject<>(addFlatArgs(commandArguments(RedisBloomProtocol.TDigestCommand.RANK).key(key),
        values), BuilderFactory.LONG_LIST);
  }

  public final CommandObject<List<Long>> tdigestRevRank(String key, double... values) {
    return new CommandObject<>(addFlatArgs(commandArguments(RedisBloomProtocol.TDigestCommand.REVRANK).key(key),
        values), BuilderFactory.LONG_LIST);
  }

  public final CommandObject<List<Double>> tdigestByRank(String key, long... ranks) {
    return new CommandObject<>(addFlatArgs(commandArguments(RedisBloomProtocol.TDigestCommand.BYRANK).key(key),
        ranks), BuilderFactory.DOUBLE_LIST);
  }

  public final CommandObject<List<Double>> tdigestByRevRank(String key, long... ranks) {
    return new CommandObject<>(addFlatArgs(commandArguments(RedisBloomProtocol.TDigestCommand.BYREVRANK).key(key),
        ranks), BuilderFactory.DOUBLE_LIST);
  }
  // RedisBloom commands
  ...
  public final CommandObject<List<String>> graphProfile(String graphName, String query) {
    return new CommandObject<>(commandArguments(GraphProtocol.GraphCommand.PROFILE).key(graphName).add(query), BuilderFactory.STRING_LIST);
  }

  public final CommandObject<List<String>> graphExplain(String graphName, String query) {
    return new CommandObject<>(commandArguments(GraphProtocol.GraphCommand.EXPLAIN).key(graphName).add(query), BuilderFactory.STRING_LIST);
  }

  public final CommandObject<List<List<String>>> graphSlowlog(String graphName) {
    return new CommandObject<>(commandArguments(GraphProtocol.GraphCommand.SLOWLOG).key(graphName), BuilderFactory.STRING_LIST_LIST);
  }

  public final CommandObject<String> graphConfigSet(String configName, Object value) {
    return new CommandObject<>(commandArguments(GraphProtocol.GraphCommand.CONFIG).add(GraphProtocol.GraphKeyword.SET).add(configName).add(value), BuilderFactory.STRING);
  }

  public final CommandObject<Map<String, Object>> graphConfigGet(String configName) {
    return new CommandObject<>(commandArguments(GraphProtocol.GraphCommand.CONFIG).add(GraphProtocol.GraphKeyword.GET).add(configName), BuilderFactory.ENCODED_OBJECT_MAP);
  }
